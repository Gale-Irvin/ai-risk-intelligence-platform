...
- Summary: Risk signal (Weak): SECURITY_RANSOMWARE affecting UNKNOWN in Cybersecurity. Evidence window: 2025-05-13 to 2025-05-13 across 1 source(s). Representative sources: How Interlock Ransomware Affects the Defense Industrial Base Supply Chain - Resecurity
...
### 4. Critical application outage disrupts business operations
- Score: 15 (L=3, I=5)
...
- Summary: Risk signal (Weak): OUTAGE_APPLICATION affecting UNKNOWN in Network Infrastructure. Evidence window: 2025-10-09 to 2025-10-09 across 1 source(s). Representative sources: AWS hit by six-hour connectivity outage in Japan - capacityglobal.com
